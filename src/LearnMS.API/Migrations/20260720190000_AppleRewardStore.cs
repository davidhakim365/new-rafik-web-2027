...
[Migration("20260720190000_AppleRewardStore")]
public partial class AppleRewardStore : Migration
{
    /// <inheritdoc />
    ...
    {
        migrationBuilder.Sql("""
            DROP TABLE IF EXISTS "AppleRewardOrders";
            DROP TABLE IF EXISTS "AppleRewardItems";
            DROP TABLE IF EXISTS "AppleStoreSettings";
            """);
    }
}
